...
type Props = {
  ...
  badgeLabel?: string;
  /** @deprecated Les teasers publics sont désactivés — seul accessLevel "full" débloque. */
...
export function ModuleVideoCard({
  ...
  void alwaysUnlocked;
  const isUnlocked = Boolean(videoUrl) && accessLevel === "full";
      ...
      <div className="mt-3">
        {isUnlocked ? (
          ...
          <LockedContent
            ...
            subtitle="Commandez la formation ou activez un code d'accès, puis connectez-vous avec le même email."
            aspect="video"
          >
