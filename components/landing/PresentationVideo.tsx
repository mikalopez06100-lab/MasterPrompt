...
export function PresentationVideo({
  ...
  return (
    <div className={`relative mx-auto w-full max-w-[360px] sm:max-w-[420px] ${className}`}>
      <div className="relative aspect-[9/16] overflow-hidden rounded-2xl border border-border bg-black shadow-[0_20px_60px_rgba(15,23,42,0.18)]">
        <video
          ref={videoRef}
          src={src}
          poster={poster}
