/**
 * Compresse (optionnel) et upload la VSL Pack IA vers Supabase Storage.
 * Usage: node scripts/upload-pack-ia-vsl.mjs [chemin.mp4]
 */
...
const DEFAULT = join(root, "public", "videos", "pack-ia-vsl-compressed.mp4");
const videoPath = process.argv[2] || DEFAULT;
const storagePath = "videos/pack-ia-vsl.mp4";
...
console.log("NEXT_PUBLIC_PACK_IA_VSL_URL=" + data.publicUrl);
